...
import com.example.rezafd.smartvillagert.ProcessActivity;
import com.example.rezafd.smartvillagert.R;

import java.util.List;

public class AdapterRT extends RecyclerView.Adapter<AdapterRT.HolderData>{
    private List<DataModel> mList;
    private Context ctx;

    public AdapterRT(List<DataModel> mList, Context ctx) {
            this.mList = mList;
            this.ctx = ctx;
        }
...
//            listjudul=(TextView)view.findViewById(R.id.listjudul);
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(ctx, ProcessActivity.class);
